C $Header: /home/ubuntu/mnt/e9_copy/MITgcm/pkg/cheapaml/CHEAPAML.h,v 1.14 2017/06/27 14:16:16 bderembl Exp $
C $Name:  $
...
C     useDLWcorrTair    :: correct imported downward longwave for Tair (off by default)
